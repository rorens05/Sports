...
class StatisticsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create statistic" do
    assert_difference('Statistic.count') do
      post statistics_url, params: { statistic: { contestant_team_id: @statistic.contestant_team_id, details: @statistic.details, player_id: @statistic.player_id } }
    end
  ...
  test "should update statistic" do
    patch statistic_url(@statistic), params: { statistic: { contestant_team_id: @statistic.contestant_team_id, details: @statistic.details, player_id: @statistic.player_id } }
